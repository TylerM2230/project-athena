...
class AiGuideService {
  ...
  private getStrategicContext(taskTitle: string, taskDescription?: string): string {
    ...
    const framework = strategicFrameworks[primaryFramework as keyof typeof strategicFrameworks];
